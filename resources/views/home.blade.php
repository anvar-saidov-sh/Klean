                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            ...
                            <a class="btn btn-primary" href={{route('posts.create')}}>Create A Quote</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex align-items-center justify-content-center">
                        <div class="p-5" style="width: 100%; max-width: 900px;">
                            ...
                            <a href={{route('posts.create')}} class="btn btn-primary">Create A Quote</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                ...
                <div class="col-lg-7 pt-5 pb-lg-5">
                    ...
                    <div class="d-flex align-items-center pt-4">
                        ...
                        <button type="button" class="btn-play" data-toggle="modal"
                            data-src="https://www.youtube.com/embed/JT37vRsBYtE?si=WlMsycro27HQyobE" " data-target="#videoModal">
                            <span></span>
                        </button>
